...
export default function HousematesNavigator() {
  return (
    <HousematesStack.Navigator options={{}}>
      <HousematesStack.Screen
        name="Default"
        component={HousematesTabNavigator}
      ...
      <HousematesStack.Screen
        name="Add"
        component={AddScreen}
        options={AddScreen.navigationOptions}
      />
      <HousematesStack.Screen
        name="Notifications"
